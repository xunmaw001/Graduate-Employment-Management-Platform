				...
				<div class="right-container">
					<form class="layui-form" lay-filter="myForm">
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="yonghuPhone" id="yonghuPhone"  lay-verify="required|phone"   placeholder="学生手机号" autocomplete="off" class="layui-input">
							</div>
						</div>
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="yonghuIdNumber" id="yonghuIdNumber"  lay-verify="required|identity"   placeholder="学生身份证号" autocomplete="off" class="layui-input">
							</div>
						</div>
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="ruxueTime" id="ruxueTime" lay-verify="required" placeholder="入学时间" autocomplete="off" class="layui-input">
							</div>
						</div>
						...
						<div class="layui-form-item">
							...
							<div  class="layui-input-inline" style="width: 500px">
								<select name="jiuyeTypes" id="jiuyeTypes">
						...
						<div class="layui-form-item">
							...
							<div  class="layui-input-inline" style="width: 500px">
								<select name="zhuanyeTypes" id="zhuanyeTypes">
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="yonghuGongsi" id="yonghuGongsi" <%--lay-verify="required"--%> placeholder="就职公司" autocomplete="off" class="layui-input">
							</div>
						</div>
