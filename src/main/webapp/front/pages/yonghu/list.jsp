                ...
                <fieldset class="search-container" style="text-align: center;">
                    <form class="layui-form" lay-filter="myForm">
                      ...
                      <div class="layui-inline" style="margin-bottom: 10px;">
                          ...
                          <div class="layui-input-inline">
                              <input type="text" name="ruxueTime" id="ruxueTime" placeholder="入学时间" autocomplete="off" class="layui-input">
                          </div>
                      </div>
                      ...
                      <div class="layui-inline" style="margin-bottom: 10px;">
                          ...
                          <div class="layui-input-inline">
                              <select name="jiuyeTypes" id="jiuyeTypes" lay-filter="jiuyeTypes">
                      ...
                      <div class="layui-inline" style="margin-bottom: 10px;">
                          ...
                          <div class="layui-input-inline">
                              <select name="zhuanyeTypes" id="zhuanyeTypes" lay-filter="zhuanyeTypes">
                                  <option value="">--请选择--</option>
                      ...
                      <div class="layui-inline" style="margin-bottom: 10px;">
                          ...
                          <div class="layui-input-inline">
                              <input type="text" name="yonghuGongsi" id="yonghuGongsi" placeholder="就职公司" autocomplete="off" class="layui-input">
                          </div>
                      </div>
...
<script>
    ...
    layui.use(['layer', 'element', 'carousel', 'laypage','form', 'http', 'jquery', 'laydate'], function() {
        ...
        function pageList() {
            ...
            if (jquery('#ruxueTime').val() != null && jquery('#ruxueTime').val() != "" && jquery('#ruxueTime').val() != "null" ) {
                param['ruxueTime'] = jquery('#ruxueTime').val();
            }
     
            var jiuyeTypes = $("#jiuyeTypes").find("option:selected").val();
            if (jiuyeTypes != null && jiuyeTypes != "" && jiuyeTypes != "null") {
                param['jiuyeTypes'] = jiuyeTypes;
            }
     
            var zhuanyeTypes = $("#zhuanyeTypes").find("option:selected").val();
            if (zhuanyeTypes != null && zhuanyeTypes != "" && zhuanyeTypes != "null") {
                param['zhuanyeTypes'] = zhuanyeTypes;
            }
     
            if (jquery('#yonghuGongsi').val() != null && jquery('#yonghuGongsi').val() != "" && jquery('#yonghuGongsi').val() != "null" ) {
                param['yonghuGongsi'] = jquery('#yonghuGongsi').val();
            }
                // 获取列表数据
...
// 当前表的字典表
       ...
       function jiuyeTypesSelect() {
           http.request("dictionary/page?page=1&limit=100&sort=&order=&dicCode=jiuye_types", 'get', {}, function (res) {
               if(res.code == 0){
       ...
       function zhuanyeTypesSelect() {
           http.request("dictionary/page?page=1&limit=100&sort=&order=&dicCode=zhuanye_types", 'get', {}, function (res) {
               if(res.code == 0){
