...
<!-- 手机号 -->
                <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        ...
                        <div class="layui-input-inline">
                            <input type="text" name="yonghuPhone" id="yonghuPhone"  lay-verify="phone|required"   placeholder="学生手机号" autocomplete="off" class="layui-input" style="width: 400px;">
                        </div>
                    </div>
                </div>
  <!-- 身份证号 -->
                <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        ...
                        <div class="layui-input-inline">
                            <input type="text" name="yonghuIdNumber" id="yonghuIdNumber"  lay-verify="identity|required"   placeholder="学生身份证号" autocomplete="off" class="layui-input" style="width: 400px;">
                        </div>
                    </div>
                </div>
                  <div class="layui-form-item layui-form-text input">
                ...
                <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        <span style="margin-top: 8px;float: left">入学时间:</span>
                        <div class="layui-input-inline">
                            <input type="text" name="ruxueTime" id="ruxueTime"  placeholder="入学时间"  lay-verify="required" autocomplete="off" class="layui-input" style="width: 600px;">
                        </div>
                    </div>
                </div>
                <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        <span style="margin-top: 8px;float: left">是否就业:</span>
                        <div class="layui-input-inline">
                            <select name="jiuyeTypes" id="jiuyeTypes" lay-filter="jiuyeTypes" style="width: 600px;">
                                <option v-for="item in jiuyeTypesList" :value="item.codeIndex" :key="item.codeIndex">{{ item.indexName }}</option>
                            </select>
                        </div>
                    </div>
                </div>
                <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        <span style="margin-top: 8px;float: left">专业:</span>
                        <div class="layui-input-inline">
                            <select name="zhuanyeTypes" id="zhuanyeTypes" lay-filter="zhuanyeTypes" style="width: 600px;">
                                <option v-for="item in zhuanyeTypesList" :value="item.codeIndex" :key="item.codeIndex">{{ item.indexName }}</option>
                            </select>
                        </div>
                    </div>
                </div>
                <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        <span style="margin-top: 8px;float: left">就职公司:</span>
                        <div class="layui-input-inline">
                            <input type="text" name="yonghuGongsi" id="yonghuGongsi"  placeholder="就职公司"  <%--lay-verify="required"--%> autocomplete="off" class="layui-input" style="width: 600px;">
                        </div>
                    </div>
                </div>
  ...
  <script>
    ...
    layui.use(['layer', 'element', 'carousel', 'form', 'http', 'jquery', 'laydate'], function() {
      ...
      function jiuyeTypesSelect() {
        //填充下拉框选项
          http.request("dictionary/page?page=1&limit=100&sort=&order=&dicCode=jiuye_types", "GET", {}, (res) => {
              if(res.code == 0){
                vue.jiuyeTypesList = res.data.list;
              }
          });
      }
      // 专业的查询
      function zhuanyeTypesSelect() {
        //填充下拉框选项
          http.request("dictionary/page?page=1&limit=100&sort=&order=&dicCode=zhuanye_types", "GET", {}, (res) => {
              if(res.code == 0){
                vue.zhuanyeTypesList = res.data.list;
              }
          });
      }
});
