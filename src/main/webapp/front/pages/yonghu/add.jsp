...
<!-- 手机号 -->
            <div class="layui-form-item" pane>
                ...
                <div class="layui-input-inline">
                    <input v-model="detail.yonghuPhone" type="text" name="yonghuPhone" id="yonghuPhone"  lay-verify="phone|required"   placeholder="学生手机号" autocomplete="off" class="layui-input">
                </div>
            </div>
        <!-- 身份证号 -->
            ...
            <div class="layui-form-item" pane>
                ...
                <div class="layui-input-inline">
                    <input v-model="detail.yonghuIdNumber" type="text" name="yonghuIdNumber" id="yonghuIdNumber"  lay-verify="identity|required"   placeholder="学生身份证号" autocomplete="off" class="layui-input">
                </div>
            </div>
            ...
            <div class="layui-form-item" pane>
                ...
                <div class="layui-input-block">
                    <input v-model="detail.ruxueTime" type="text" name="ruxueTime" id="ruxueTime" placeholder="入学时间" lay-verify="required" autocomplete="off"
                           class="layui-input">
                </div>
            </div>
            ...
            <div class="layui-form-item" pane>
                ...
                <div class="layui-input-block">
                    <input v-model="detail.yonghuGongsi" type="text" name="yonghuGongsi" id="yonghuGongsi" placeholder="就职公司" lay-verify="required" autocomplete="off"
                           class="layui-input">
                </div>
            </div>
