            ...
            <div class="ng-inmod-ini">
                <div class="ng-fault ng-container">
                    <div class="ng-inmod-the ng-container ng-bg-fff">
                        ...
                        <span class="ng-inmod-the-cn" aos="fade-down">政策法规展示</span>
                ...
                <fieldset class="search-container" style="text-align: center;">
                    <form class="layui-form" lay-filter="myForm">
                      <div class="layui-inline" style="margin-bottom: 10px;">
                          <label class="layui-form-label" style="width: 130px">政策法规名称</label>
                          <div class="layui-input-inline">
                              <input type="text" name="zhengcefaguiName" id="zhengcefaguiName" placeholder="政策法规名称" autocomplete="off" class="layui-input">
                          </div>
                      </div>

                      <div class="layui-inline" style="margin-bottom: 10px;">
                          <label class="layui-form-label" style="width: 130px">政策法规类型</label>
                          <div class="layui-input-inline">
                        ...
                        <div class="article-list">
                            <ul class="after">
                                <li v-for="(item,index) in dataList" v-bind:key="index">
                                    <a target="_self" :href="'../zhengcefagui/detail.jsp?id='+item.id">
                                        <img width="180" class="fl" :src="item.zhengcefaguiPhoto" />
                                        <h5>{{item.zhengcefaguiName}}</h5>
                                        <p class="time-sour">
                                            <span>发布时间：{{item.insertTime}} </span>
                                        </p>
                                        <p class="reamk">{{item.zhengcefaguiContent|zhengcefaguiContent}}...</p>
                                    </a>
                                </li>
                            </ul>
                            <div class="pages">
...
<script>
    var vue = new Vue({
        ...
        filters: {
            //把 zhengcefaguiContent 字段去除无用字符 如果字段长度大于60  就截取到60
            zhengcefaguiContent: function(val) {
                if (val) {
    ...
    layui.use(['layer', 'element', 'carousel', 'laypage','form', 'http', 'jquery', 'laydate'], function() {
        ...
        function pageList() {
            ...
            if (jquery('#zhengcefaguiName').val() != null && jquery('#zhengcefaguiName').val() != "" && jquery('#zhengcefaguiName').val() != "null" ) {
                param['zhengcefaguiName'] = jquery('#zhengcefaguiName').val();
            }
     
            var zhengcefaguiTypes = $("#zhengcefaguiTypes").find("option:selected").val();
            if (zhengcefaguiTypes != null && zhengcefaguiTypes != "" && zhengcefaguiTypes != "null") {
                param['zhengcefaguiTypes'] = zhengcefaguiTypes;
            }
                            // 获取列表数据
            http.request('zhengcefagui/list', 'get', param, function(res) {
...
// 当前表的字典表
       ...
       function zhengcefaguiTypesSelect() {
           http.request("dictionary/page?page=1&limit=100&sort=&order=&dicCode=zhengcefagui_types", 'get', {}, function (res) {
               if(res.code == 0){
