	...
	<body style="background: #EEEEEE;">
					...
					<form class="layui-form" lay-filter="myForm">
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="zhengcefaguiName" id="zhengcefaguiName" lay-verify="required" placeholder="政策法规名称" autocomplete="off" class="layui-input">
							</div>
						</div>
						...
						<div class="layui-form-item">
							...
							<div  class="layui-input-inline" style="width: 500px">
								<select name="zhengcefaguiTypes" id="zhengcefaguiTypes">
						...
						<div class="layui-form-item">
							<div class="layui-input-block">
								<img id="zhengcefaguiPhotoImg"
									 ...
									 src="../../img/avator.png">
								<input type="hidden" id="zhengcefaguiPhoto" name="zhengcefaguiPhoto"/>
							</div>
						</div>
		...
		<script>
            ...
            layui.use(['layer', 'element', 'carousel', 'http', 'jquery', 'form', 'upload', 'laydate'], function () {
                ...
                http.request(`zhengcefagui/session`, 'get', {}, function (data) {
                    // 表单赋值
                    form.val("myForm", data.data);
					jquery("#zhengcefaguiPhotoImg").attr("src", data.data.zhengcefaguiPhoto);
                });
