              ...
              <form class="layui-form login-form" lay-filter="register">
                <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        <span style="margin-top: 8px;float: left">公司名称:</span>
                        <div class="layui-input-inline">
                            <input type="text" name="zhaopinName" id="zhaopinName"  placeholder="公司名称"  lay-verify="required" autocomplete="off" class="layui-input" style="width: 600px;">
                        </div>
                    </div>
                </div>
                <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        <span style="margin-top: 8px;float: left">招聘开始时间:</span>
                        <div class="layui-input-inline">
                            <input type="text" name="zhaopinStartTime" id="zhaopinStartTime"  placeholder="招聘开始时间"  lay-verify="required" autocomplete="off" class="layui-input" style="width: 600px;">
                        </div>
                    </div>
                </div>
                <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        <span style="margin-top: 8px;float: left">招聘结束时间:</span>
                        <div class="layui-input-inline">
                            <input type="text" name="zhaopinEndTime" id="zhaopinEndTime"  placeholder="招聘结束时间"  lay-verify="required" autocomplete="off" class="layui-input" style="width: 600px;">
                        </div>
                    </div>
                </div>
