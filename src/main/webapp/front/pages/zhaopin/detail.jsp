...
<div id="app">
    <div class="data-detail">
        <div class="data-detail-breadcrumb">
            ...
            <!-- 收藏 -->
            <a onclick="addZhaopinCollection()" href="javascript:void(0)">
        ...
        <div class="layui-row">
            ...
            <div class="layui-col-md7" style="padding-left: 20px;">
                ...
                <div v-if="detail.zhaopinStartTime" class="detail-item">
                    <span>招聘开始时间：</span>
                    <span class="desc">
                                {{detail.zhaopinStartTime}}
                            </span>
                </div>

                <div v-if="detail.zhaopinEndTime" class="detail-item">
                    <span>招聘结束时间：</span>
                    <span class="desc">
                                {{detail.zhaopinEndTime}}
                            </span>
                </div>

                <div class="detail-item">

                    <!--<button onclick="addZhaopinqqqqqqqq()" type="button" class="layui-btn layui-btn-warm">
                        添加到购物车
                    </button>-->
                </div>
            ...
            <div class="layui-tab layui-tab-card">
                ...
                <div class="layui-tab-content">
                    ...
                    <div class="layui-tab-item layui-show">
                        <div v-html="detail.zhaopinContent"></div>
                    </div>
