...
<!-- 手机号 -->
  ...
  <!-- 身份证号 -->
                <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        <span style="margin-top: 8px;float: left">老师身份证号:</span>
                        <div class="layui-input-inline">
                            <input type="text" name="laoshiIdNumber" id="laoshiIdNumber"  lay-verify="identity|required"   placeholder="老师身份证号" autocomplete="off" class="layui-input" style="width: 400px;">
                        </div>
                    </div>
                </div>
                  <div class="layui-form-item layui-form-text input">
