            ...
            <div class="ng-inmod-ini">
                <div class="ng-fault ng-container">
                    <div class="ng-inmod-the ng-container ng-bg-fff">
                        ...
                        <span class="ng-inmod-the-cn" aos="fade-down">老师展示</span>
                ...
                <fieldset class="search-container" style="text-align: center;">
                    <form class="layui-form" lay-filter="myForm">
                      ...
                      <div class="layui-inline" style="margin-bottom: 10px;">
                          ...
                          <div class="layui-input-inline">
                              <input type="text" name="laoshiPhone" id="laoshiPhone" placeholder="老师手机号" autocomplete="off" class="layui-input">
                          </div>
                      </div>
     
                      <div class="layui-inline" style="margin-bottom: 10px;">
                          <label class="layui-form-label">老师身份证号</label>
                          <div class="layui-input-inline">
                              <input type="text" name="laoshiIdNumber" id="laoshiIdNumber" placeholder="老师身份证号" autocomplete="off" class="layui-input">
                          </div>
                      </div>
...
<script>
    var vue = new Vue({
        ...
        filters: {
            //把 laoshiContent 字段去除无用字符 如果字段长度大于60  就截取到60
            laoshiContent: function(val) {
                if (val) {
    ...
    layui.use(['layer', 'element', 'carousel', 'laypage','form', 'http', 'jquery', 'laydate'], function() {
        ...
        function pageList() {
            ...
            if (jquery('#laoshiPhone').val() != null && jquery('#laoshiPhone').val() != "" && jquery('#laoshiPhone').val() != "null" ) {
                param['laoshiPhone'] = jquery('#laoshiPhone').val();
            }
     
            if (jquery('#laoshiIdNumber').val() != null && jquery('#laoshiIdNumber').val() != "" && jquery('#laoshiIdNumber').val() != "null" ) {
                param['laoshiIdNumber'] = jquery('#laoshiIdNumber').val();
            }
                        // 获取列表数据
