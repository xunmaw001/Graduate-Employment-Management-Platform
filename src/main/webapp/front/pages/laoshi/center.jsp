				...
				<div class="right-container">
					<form class="layui-form" lay-filter="myForm">
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="laoshiIdNumber" id="laoshiIdNumber"  lay-verify="required|identity"   placeholder="老师身份证号" autocomplete="off" class="layui-input">
							</div>
						</div>
