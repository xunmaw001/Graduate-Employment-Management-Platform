...
var centerMenu = [
    ...
    ,{
        name: '宣讲会收藏',
        url: '../xuanjianghuiCollection/list.jsp'
    }
    ,{
        name: '招聘收藏',
        url: '../zhaopinCollection/list.jsp'
    }
...
var indexNav = [
    ...
    {
        name: '就业指导',
        url: './pages/jiuyezhidao/list.jsp'
    },
    {
        name: '宣讲会',
        url: './pages/xuanjianghui/list.jsp'
    },
    {
        name: '招聘',
        url: './pages/zhaopin/list.jsp'
    },
    {
        name: '政策法规',
        url: './pages/zhengcefagui/list.jsp'
    },
    {
        name: '咨询老师',
        url: './pages/zixun/list.jsp'
    },

]

var adminurl =  "http://localhost:8080/biyeshengjiuyeguanli/index.jsp";
