...
<!--/Pre Loader -->
    ...
    <!-- 本表的查询条件 -->
            ...
            var zhaopinStartTimeStartSearch = $('#zhaopinStartTimeStartSearch');
            if( zhaopinStartTimeStartSearch != null){
                if (zhaopinStartTimeStartSearch.val() != null && zhaopinStartTimeStartSearch.val() != '') {
                    searchForm.zhaopinStartTimeStart = $('#zhaopinStartTimeStartSearch').val();
                }
            }
            var zhaopinStartTimeEndSearch = $('#zhaopinStartTimeEndSearch');
            if( zhaopinStartTimeEndSearch != null){
                if (zhaopinStartTimeEndSearch.val() != null && zhaopinStartTimeEndSearch.val() != '') {
                    searchForm.zhaopinStartTimeEnd = $('#zhaopinStartTimeEndSearch').val();
                }
            }
     
            var zhaopinEndTimeStartSearch = $('#zhaopinEndTimeStartSearch');
            if( zhaopinEndTimeStartSearch != null){
                if (zhaopinEndTimeStartSearch.val() != null && zhaopinEndTimeStartSearch.val() != '') {
                    searchForm.zhaopinEndTimeStart = $('#zhaopinEndTimeStartSearch').val();
                }
            }
            var zhaopinEndTimeEndSearch = $('#zhaopinEndTimeEndSearch');
            if( zhaopinEndTimeEndSearch != null){
                if (zhaopinEndTimeEndSearch.val() != null && zhaopinEndTimeEndSearch.val() != '') {
                    searchForm.zhaopinEndTimeEnd = $('#zhaopinEndTimeEndSearch').val();
                }
            }
                    getDataList();
        }
