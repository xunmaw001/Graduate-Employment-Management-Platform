            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">招聘收藏登记</li>
                    </ol>
                </div>
            </div>
        </div>
                    ...
                    <div class="widget-area-2 lochana-box-shadow">
                        ...
                        <form id="addOrUpdateForm">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input id="zhaopinName" name="zhaopinName" class="form-control"
                                                   v-model="ruleForm.zhaopinName" readonly>
                                        </div>


                                    <div class="form-group col-md-6">
                                        <label>公司图片</label>
                                        <img id="zhaopinPhotoImg" width="100" height="100">
                                    </div>

                                        <div class="form-group col-md-6">
                                            <label>招聘开始时间</label>
                                            <input id="zhaopinStartTime" name="zhaopinStartTime" class="form-control"
                                                   v-model="ruleForm.zhaopinStartTime" readonly>
                                        </div>
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input id="zhaopinEndTime" name="zhaopinEndTime" class="form-control"
                                                   v-model="ruleForm.zhaopinEndTime" readonly>
                                        </div>
                            ...
                            <!-- 本表所有字段 -->
                                ...
                                <input id="zhaopinId" name="zhaopinId" v-model="ruleForm.zhaopinId" readonly type="hidden">
...
<script>
    ...
    var vm = new Vue({
        ...
        beforeCreate: function () {
            ...
            if (id != null && id != "" && id != "null") {
                $.ajax({
                    type: "GET",
                    url: baseUrl + "zhaopinCollection/info/" + id,
    ...
    function setContent() {
        ...
        if (ruleForm.zhaopinContent != null && ruleForm.zhaopinContent != 'null' && ruleForm.zhaopinContent != '') {
            var zhaopinContentUeditor = UE.getEditor('zhaopinContentEditor');
                zhaopinContentUeditor.ready(function () {
                    ...
                    zhaopinContentUeditor.setDisabled('fullscreen');
            });
        }
    }
