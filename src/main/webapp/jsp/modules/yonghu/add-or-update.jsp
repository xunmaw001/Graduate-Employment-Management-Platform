                            ...
                            <!-- 当前表的字段 -->
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input id="yonghuPhone" name="yonghuPhone" class="form-control"
                                               onchange="yonghuPhoneChickValue(this)"  placeholder="学生手机号">
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label>学生身份证号</label>
                                        <input id="yonghuIdNumber" name="yonghuIdNumber" class="form-control"
                                               onchange="yonghuIdNumberChickValue(this)"  placeholder="学生身份证号">
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label>学生头像</label>
                                    ...
                                    <div class="form-group col-md-6">
                                        <label>入学时间</label>
                                        <input id="ruxueTime-input" name="ruxueTime" type="text" class="form-control layui-input">
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label>是否就业</label>
...
<script>
    ...
    <!--  当前表的数据回显  -->
        ...
        $("#ruxueTime-input").val(ruleForm.ruxueTime);
