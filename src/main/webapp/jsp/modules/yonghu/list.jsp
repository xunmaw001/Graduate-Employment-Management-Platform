...
<!--/Pre Loader -->
                            ...
                            <div class="table-responsive mb-3">
                                <div class="col-sm-12">
                                    ...
                                    <div class="layui-inline" style="margin-left: 30px;margin-bottom: 10px;">
                                        ...
                                        <button onclick="graph_sex()" type="button" class="btn btn-success 报表">性别统计报表</button>
                                        <button onclick="graph_jiuye()" type="button" class="btn btn-success 报表">就业统计报表</button>
                                        <button onclick="graph_zhuanye()" type="button" class="btn btn-success 报表">专业统计报表</button>
    ...
    <!-- 本表的查询条件 -->
        ...
        //性别统计报表
        function graph_sex() {
            window.location.href = "graph_sex.jsp"
        }
        //就业统计报表
        function graph_jiuye() {
            window.location.href = "graph_jiuye.jsp"
        }
        //专业统计报表
        function graph_zhuanye() {
            window.location.href = "graph_zhuanye.jsp"
        }
