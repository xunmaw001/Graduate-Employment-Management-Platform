            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">就业管理</li>
                        <li class="breadcrumb-item active">就业统计</li>
                    </ol>
                </div>
            </div>
        </div>
                    ...
                    <div class="widget-area-2 lochana-box-shadow min-h200">
                        ...
                        <div class="layui-inline" style="margin-bottom: 10px;">
                            ...
                            <div class="layui-input-inline">
                                <input type="text" id="ruxueTime" style="width: 180px;"
...
<script>
    ...
    function getDetails() {
        ...
        if(ruxueTime == null || ruxueTime == ""){
            var date = new Date();
            ruxueTime = date.getFullYear();
        }

        //填充下拉框选项
        http("/yonghu/graphJiuye/"+ruxueTime, "GET", null, (res) => {
            if(res.code == 0){
                var data = res.data;
                debugger
                if(data == null || data.length == 0){
                    alert(ruxueTime+"年没有数据");
                }else{
                    draw(data);
                }
            }else{
