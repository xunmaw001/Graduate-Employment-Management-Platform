                ...
                <div class="row breadcrumb-bar">
                    ...
                    <div class="col-md-6">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">咨询列表</li>
                        </ol>
                    </div>
                </div>
            </div>
                            ...
                            <div class="table-responsive mb-3">
                                <div class="col-sm-12">
                                    ...
                                    <div class="layui-inline" style="margin-bottom: 10px;">
                                        老师手机号
                                        <div class="layui-input-inline">
                                            <input type="text" id="laoshiPhoneSearch" style="width: 140px;" class="form-control form-control-sm"
                                                   placeholder="老师手机号" aria-controls="tableId">
                                        </div>
                                    </div>
                                    ...
                                    <div class="layui-inline" style="margin-bottom: 10px;">
                                        ...
                                        <div class="layui-input-inline">
                                            <input type="text" id="laoshiIdNumberSearch" style="width: 140px;" class="form-control form-control-sm"
                                                   placeholder="老师身份证号" aria-controls="tableId">
                                        </div>
                                    </div>
    ...
    <script>
            ...
            if( laoshiNameSearchInput != null){
                if (laoshiNameSearchInput.val() != null && laoshiNameSearchInput.val() != '') {
                    searchForm.laoshiName = $('#laoshiNameSearch').val();
                            ...
                            //老师手机号
            var laoshiPhoneSearchInput = $('#laoshiPhoneSearch');
            if( laoshiPhoneSearchInput != null){
                if (laoshiPhoneSearchInput.val() != null && laoshiPhoneSearchInput.val() != '') {
                    searchForm.laoshiPhone = $('#laoshiPhoneSearch').val();
                }
            }
        ...
        function getDataList() {
            ...
            //级联表的
                ...
                laoshiPhone: searchForm.laoshiPhone,
        ...
        function setDataRow(item, number) {
            ...
            row.appendChild(sexTypesCell);
                ...
                //老师介绍详情
            var zixunContentCell = document.createElement('td');
            //如果图文详情包含图片
            if (item.zixunContent && item.zixunContent.indexOf('img') != -1) {
                //暂时只考虑图片+文字 和 文字+图片的情况
                var beginIndex = item.zixunContent.indexOf('<img');
                var endIndex = item.zixunContent.indexOf('>');
                    zixunContentCell.innerHTML = item.zixunContent.substring(beginIndex, endIndex + 1).replace("img", "img width='100' height='100'");
            } else {
                if (item.zixunContent != null && item.zixunContent != "" && item.zixunContent.length >= 11) {
                        zixunContentCell.innerHTML = item.zixunContent.substring(0, 10) + "...";
                } else {
                        zixunContentCell.innerHTML = item.zixunContent;
                }
            }
            row.appendChild(zixunContentCell);
        ...
        function remove(id) {
            ...
            if (mymessage == true) {
                ...
                httpJson("zixun/delete", "POST", paramArray, (res) => {
                    if(res.code == 0){
                        getDataList();
                        alert('删除成功');
                    }
        ...
        //添加
        function add() {
            window.sessionStorage.setItem("addzixun", "addzixun");
            window.location.href = "add-or-update.jsp"
        }
