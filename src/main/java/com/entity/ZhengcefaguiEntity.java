...
public class ZhengcefaguiEntity<T> implements Serializable {
    private static final long serialVersionUID = 1L;


	public ZhengcefaguiEntity() {

	}

	public ZhengcefaguiEntity(T t) {
		try {
    ...
    public String toString() {
        return "Zhengcefagui{" +
            "id=" + id +
            ", zhengcefaguiName=" + zhengcefaguiName +
            ", zhengcefaguiTypes=" + zhengcefaguiTypes +
            ", zhengcefaguiPhoto=" + zhengcefaguiPhoto +
            ", insertTime=" + insertTime +
            ", zhengcefaguiContent=" + zhengcefaguiContent +
