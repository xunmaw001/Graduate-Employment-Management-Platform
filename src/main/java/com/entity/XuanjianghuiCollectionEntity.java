...
public class XuanjianghuiCollectionEntity<T> implements Serializable {
    private static final long serialVersionUID = 1L;


	public XuanjianghuiCollectionEntity() {

	}

	public XuanjianghuiCollectionEntity(T t) {
		try {
