...
public class XuanjianghuiCollectionController {
    ...
    */
    ...
    public R update(@RequestBody XuanjianghuiCollectionEntity xuanjianghuiCollection, HttpServletRequest request){
        logger.debug("update方法:,,Controller:{},,xuanjianghuiCollection:{}",this.getClass().getName(),xuanjianghuiCollection.toString());
        //根据字段查询是否有相同数据
        Wrapper<XuanjianghuiCollectionEntity> queryWrapper = new EntityWrapper<XuanjianghuiCollectionEntity>()
            .notIn("id",xuanjianghuiCollection.getId())
            .andNew()
            .eq("xuanjianghui_id", xuanjianghuiCollection.getXuanjianghuiId())
            .eq("yonghu_id", xuanjianghuiCollection.getYonghuId())
            ;
    ...
    */
    @RequestMapping("/add")
    public R add(@RequestBody XuanjianghuiCollectionEntity xuanjianghuiCollection, HttpServletRequest request){
        logger.debug("add方法:,,Controller:{},,xuanjianghuiCollection:{}",this.getClass().getName(),xuanjianghuiCollection.toString());
        Wrapper<XuanjianghuiCollectionEntity> queryWrapper = new EntityWrapper<XuanjianghuiCollectionEntity>()
            .eq("xuanjianghui_id", xuanjianghuiCollection.getXuanjianghuiId())
            .eq("yonghu_id", xuanjianghuiCollection.getYonghuId())
            ;
